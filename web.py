...
diabetes_model = pickle.load(open(r"C:\DiseaseOutbreak\training_models\diabetes_model.sav", 'rb'))
heart_disease_model = pickle.load(open(r"C:\DiseaseOutbreak\training_models\heart_model.sav", 'rb'))
parkinsons_disease_model = pickle.load(open(r"C:\DiseaseOutbreak\training_models\parkinsons_model.sav", 'rb'))
